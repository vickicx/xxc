...
- (void)onLogin:(NIMLoginStep)step
{
    switch (step)
    {
        case NIMLoginStepSyncOK:
        {
            ...
            BOOL isOnLine = [NTESConfig sharedConfig].redPacketConfig.useOnlineEnv;
            NSString *aliPaySchemeUrl = [NTESConfig sharedConfig].redPacketConfig.aliPaySchemeUrl;
            NSString *weChatSchemeUrl = [NTESConfig sharedConfig].redPacketConfig.weChatSchemeUrl;
