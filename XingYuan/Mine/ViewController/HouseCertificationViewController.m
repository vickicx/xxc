//
//  HouseCertificationViewController.m
//  XingYuan
//
...
@interface HouseCertificationViewController ()<UIImagePickerControllerDelegate>
@property (nonatomic,weak) UIImage *img;
@end

@implementation HouseCertificationViewController
...
- (void)requestData {
    ...
    [parameters setValue:@"1" forKey:@"filetype"];//购车认证2 购房认证1
