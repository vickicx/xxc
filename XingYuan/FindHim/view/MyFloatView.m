...
- (void)createView {
    ...
    self.authenticationschedule = [[UILabel alloc] initWithFrame:CGRectMake(imageView1.left, treasure1.bottom + 2, 70, 14)];
    ...
    UILabel *treasure2 = [[UILabel alloc] initWithFrame:CGRectMake(imageView2.left - 12, imageView2.bottom + 10, 100, 14)];
    ...
    self.memberinfoschedule = [[UILabel alloc] initWithFrame:CGRectMake(0, treasure2.bottom + 2, 70, 14)];
